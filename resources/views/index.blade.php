    ...
    <div class="header-inner">
      ...
      <div class="header-overlay">
        ...
        <div class="header-btn-area">
          <a class="knowmore-btn" href="{{url('lg')}}">LOGIN</a>
          <a class="download-btn" href="{{url('rg')}}">SIGN UP</a>
        </div>
      </div>
      </div>      
    </div>
...
@section('content')
  ...
  <section id="call-to-action">
    <img src="{{ url('public/images/call-to-action-bg.png')}}" alt="img">
              ...
              <ul class="service-table">
                ...
                <li class="col-md-3 col-sm-6">
                 <div class="single-service wow slideInUp">
                    ...
                    <p>Minimalist and attrative design used to enhance the website's interface</p>
                  </div>
                </li>
                <li class="col-md-3 col-sm-6">
                  <div class="single-service wow slideInUp">
  ...
  <section id="testimonial">
    <img src="{{ url('public/images/testimonial-bg.jpg')}}" alt="img">
                ...
                <div class="testimonial-slider">
                  ...
                  <div class="single-slide">
                    ...
                    <div class="single-testimonial">
                      <img class="testimonial-thumb" src="{{ URL::asset('public/images/user-1.jpg')}}" alt="img">
                      <p>Al Aiman</p>
                  ...
                  <div class="single-slide">
                    ...
                    <div class="single-testimonial">
                      <img class="testimonial-thumb" src="{{ URL::asset('public/images/user-2.jpg')}}" alt="img">
                      <p>Yusuf Hisham</p>
                  ...
                  <div class="single-slide">
                    ...
                    <div class="single-testimonial">
                      <img class="testimonial-thumb" src="{{ URL::asset('public/images/user-3.jpg') }}" alt="img">
                      <p>Wee Keong T</p>
        ...
        <div class="col-md-12">
          <div class="client-area">
            <ul class="client-table">
              <li><img src="{{ URL::asset('public/images/1.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/3.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/4.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/5.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/6.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/7.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/8.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/1.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/3.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/4.png')}}" alt="client logo"></li>
              <li><img src="{{ URL::asset('public/images/5.png')}}" alt="client logo"></li>
